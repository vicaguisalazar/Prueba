<%-- 
    Document   : ListaCurso
    Created on : 31-jul-2014, 0:49:48
    Author     : Victor
--%>
...
<html lang="en">
    <head>
        ...
        <script>
            function aExcel(){
                vExcel = window.open("Exportar/ExportarCursos.jsp","","status=0,toolbar=0,location=0,menubar=0,resizable=0,width=400,height=200");
            }
...
<div id="content">
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <ul class="toolbar">
                <li><a href="Curso.jsp?txtOption=1" title=""><i class="icon-heart"></i><span>New file</span></a></li>
                ...
                <table class="table" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            %>
                            <td> <a href="Curso.jsp?txtOption=2&txtCodigo=<%=c.getIdCurso() %>" class="tip" title="Editar"><i class="fam-pencil"></i></a></td>
                            <td><a href="CursoController?txtOption=3&txtCodigo=<%=c.getIdCurso() %>" class="tip" title="Eliminar"><i class="fam-cross"></i></a></td>
                        </tr>
                        <%
                            }
                        %>

<%-- 
    Document   : ListaGrado
    Created on : 31-jul-2014, 1:31:14
    Author     : Victor
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="pe.com.vs.entity.Grado"%>
<%@page import="pe.com.vs.context.appContext"%>
<%@page import="pe.com.vs.business.GradoBusiness"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    Usuario u = (Usuario) session.getAttribute("usuarioInicio");
    GradoBusiness gradoBusiness = (GradoBusiness) appContext.getService("GradoBusiness");
    Iterable<Grado> listar = new ArrayList<Grado>();
    if(u.getNPrivilegio()!='E'){
        listar = gradoBusiness.ListarPersonalizado();
    }else{
        listar = gradoBusiness.ListarTodo();
    }
%>
<!DOCTYPE html>
<html lang="en">
                ...
                <table class="table" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            %>
                            <td> <a href="#" class="tip" title="Editar"><i class="fam-pencil"></i></a></td>
                            <td><a href="#" class="tip" title="Eliminar"><i class="fam-cross"></i></a></td>
                        </tr>
                        <%
                            }
                        %>

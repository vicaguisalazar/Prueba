<%-- 
    Document   : ListaSeccion
    Created on : 30-jul-2014, 23:12:48
    Author     : Victor
--%>
...
<%  
    ...
    Iterable<Seccion> listar = new ArrayList<Seccion>();
    if (u.getNPrivilegio() != 'E') {
        listar = seccionBusiness.ListarPersonalizado();
    } else {
        listar = seccionBusiness.ListarTodo();
    }
%>
<html lang="en">
    <head>
...
<div id="content">
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <ul class="toolbar">
            <li><a href="Seccion.jsp?txtOption=1" title=""><i class="icon-heart"></i><span>New file</span></a></li>
                ...
                <table class="table" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            %>
                            <td> <a href="Seccion.jsp?txtOption=2&txtCodigo=<%=s.getIdSeccion() %>" class="tip" title="Editar"><i class="fam-pencil"></i></a></td>
                            <td><a href="SeccionController?txtOption=3&txtCodigo=<%=s.getIdSeccion() %>" class="tip" title="Eliminar"><i class="fam-cross"></i></a></td>
                        </tr>
                        <%
                            }
                        %>

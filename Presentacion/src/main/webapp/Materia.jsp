<%-- 
    Document   : Materia
    Created on : 05-ago-2014, 8:18:21
                        ...
                        <div class="well">
                            ...
                            <div class="control-group">
                                ...
                                <%
                                    if (txtoption == 2) {
                                %>
                                <div class="controls"><input class="input-mini" type="text" name="txtCodigo" readonly value="<%=materia.getIdMateria() %>"/></div>
                                    <%
                                    } else {
                                    %>
                            ...
                            <div class="control-group">
                                ...
                                <%
                                    if (txtoption== 2) {
                                %>
                                <div class="controls"><input type="text" name="txtNombre" maxlength="10" placeholder="Ingresa Nombre" class="input-xlarge" value="<%=materia.getNNombre() %>" /></div>
                                    <%
                                    } else {
